...
[symbols ,Rx, Tx, noise]=FSK(M, N, T_bit, samplingrate_bit, 10, 1);
figure;
...
subplot(2,2,4);
%symbol estimation
Rx_bpf=bandpass(Rx,[estimated_f(1)-estimated_f(1)/2,estimated_f(2)+estimated_f(2)/2], Fs); %BPF는 FFT보고 조정가능
[c,l] = dwt(Rx_bpf, 'haar');
