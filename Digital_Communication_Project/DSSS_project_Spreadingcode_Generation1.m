...
title("preferred PN code(x^6+x+1, x^6+x^5+x^2+x+1), Crosscorrelation(-1/63(-0.015), -17/63(-0.269), 15/63(0.238))")
...
title("Gold code added with 0 Autocorrelation")
...
title("Gold code added with 0 Crosscorrelation")