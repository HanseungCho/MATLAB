...
[cf, tau, Tx_psd, p] = cyclic_autocorr(Tx, 0, fs);
...
figure(6)
[cf, tau, Tx_s1_psd, p] = cyclic_autocorr(Tx_s1, 1, fs);
...
figure(7)
[cf, tau, Tx_s2_psd, p] = cyclic_autocorr(Tx_s2, 1, fs);
...
figure(8)
[cf, tau, Rx_psd, p] = cyclic_autocorr(noise, 0, fs);
